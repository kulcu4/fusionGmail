...
const DetailPage = ({ media, onClose, favorites, onToggleFavorite, unlockedEffects, user, onUnlockRequest, onUpdateUser, setConfirmationModal, onGoToShop, tempUnlockedItems, onClearTempUnlock, provider }: DetailPageProps) => {
